const champVars = {
    ...
    Urgot: {
        sInfoP: {
            ...
            p1Var: {
                link: "attackdamage",
                coeff: [0.4, 0.4, 0.4, 0.4, 0.4, 0.5, 0.5, 0.5, 0.65, 0.65, 0.65, 0.8, 0.8, 0.9, 0.9, 1, 1, 1, 1]
            },
            p2: {
                info: ["Damage"],
                type: "phys",
                apply: "maxHp",
                valuePerLvl: [2, 2, 2, 2, 2, 3, 3, 3, 4, 4, 6, 6, 8, 8, 8, 8, 8, 8, 8]
            }
        },
        sInfo0: {
            e2: {
    ...
    Zoe: {
        ...
        sInfo0: {
            f1: {
                effectNo: 1,
                valuePerLvl: [7, 8, 9, 10, 12, 14, 16, 18, 20, 22, 24, 26, 29, 32, 35, 38, 42, 46, 50],
                spell: true,
                type: "mag",
                child: ["a1"]
            },
